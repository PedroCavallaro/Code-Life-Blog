    ...
    return (
        <main className="mt-4 lg:flex lg:items-center lg:justify-center">
            <form className="flex flex-col justify-center items-center gap-4">
                <div className="flex w-[90%] text-center p-2 bg-purple-500 text-purple-50 rounded-md shadow lg:w-[320px] lg:h-[55px] lg:ml-40 lg:mt-12 animate-pulse">
                ...
                <Input
                    type="submit"
                    value="Enviar"
                    className="flex w-[90%]  items-center justify-center p-2 bg-purple-500 text-purple-50 rounded-md shadow mt-4 
